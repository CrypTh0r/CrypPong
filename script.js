...
let ball = { x: 200, y: 200, dx: -3, dy: 3, image: 'https://i.postimg.cc/Mn5p1pMY/ball.png', size: 20 }; // Ball properties with increased speed, image, and bigger size
let player1Score = 0;
let player2Score = 0;
...
function resetGame() {
    player1 = { x: 10, y: 170 };
    player2 = { x: 380, y: 170 };
    ball = { x: 200, y: 200, dx: -3, dy: 3, image: 'https://i.postimg.cc/Mn5p1pMY/ball.png', size: 20 };
    rounds = 0;
    aiChallenging = false;
    gamePaused = false;
    resetSpeed();
